...
class BinaryExpression(Base_Node):
    ...
    def parse_node(self):
        ...
        self.process_node(self.left )                      # todo: find a better way to capture
        self.process_node(self.right)                      #       this left and right relationship